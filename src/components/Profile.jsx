    ...
    en: {
      description: (
        ...
        <span className="block text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 font-bold text-6xl p-5 mb-5">
            ...
            I'm a full-stack developer based in Taiwan. My goal is to become a versatile and efficient software engineer. ready to provide valuable assistance in various areas of development. If you're looking to hire a junior web developer, please get in touch!
        </>
      ),
      contact: 'Contact',
    },
    zh: {
      description: (
        <>
            ...
            我是來自新北市的全端工程師。我的目標是成為一名靈活且高效的軟體工程師，能夠在各個領域提供幫助。如果你正在尋找 junior 網頁開發工程師，請與我聯繫！
        </>
      ),
      contact: '聯絡方式',
    }
